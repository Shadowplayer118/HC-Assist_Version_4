    ...
    $.ajax({
        ...
        success: function(response) {
            try {
                ...
                $('#disease_name').val(patient.disease_name);
                $('#diagnosis_date').val(patient.diagnosis_date);
                $('#disease_status').val(patient.disease_status);
                $('#disease_stage').val(patient.disease_stage); 
