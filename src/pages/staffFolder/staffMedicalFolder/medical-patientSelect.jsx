...
import MedicalModal from './medical-addModal';
// import AddDiseaseModal from './disease-addModal';

const Patientselect_Medical = () => {
  ...
  return (
    <div>
      <Topbar location={
          <>
            <a href="/medical" className='topLink'>Medical Records</a>  &gt; Patient Select
          </>
        } />
      <div className="mainbarContent">
        ...
        <div className="main">
          <div className="main-container">
            ...
            <MedicalModal  visible={isOpenAddModal} onClose={() => setIsOpenAddModal(false)} data={selectedPatient}/>
...
export default Patientselect_Medical;
