...
const ChildModal = ({ visible, onClose, data }) => {
  ...
  formData.append('child_patient_id', data?.patient_id || ''); 
  formData.append('child_status', Status);
  ...
  try {
    const response = await axios.post(
      'http://localhost/HC-Assist_Version_4/php/new_php/HC-Assist_API/Admin/child/child_add.php',
      formData, {
        headers: {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="addDisease-input-right Fix-inputRightDiseaseAdd">
            ...
            <div className="input-container">
              ...
              <div className="input-container">
                <label htmlFor="addDisease-blood_type">Child Status:</label> <br />
            ...
            <div className="input-container">
                <label htmlFor="addDisease-bdate">Guardian:</label>
                <input type="text" id="child-guard" name="disease_treatmentSched"  onChange={(e) => setGuardian(e.target.value)} required />
              </div>

              <div className="input-container">
                <label htmlFor="addDisease-bdate">Guardian Contact:</label>
                <input type="text" id="child-contact" name="disease_treatmentSched"  onChange={(e) => setContact(e.target.value)} required />
              </div>
