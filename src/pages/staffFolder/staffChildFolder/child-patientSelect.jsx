...
const Patientselect_Child = () => {
  ...
  async function fetchPatientData() {
    try {
      const res = await axios.get('http://localhost/HC-Assist_Version_4/php/new_php/HC-Assist_API/Admin/child/childPatient_load.php');
  ...
  return (
    <div>
      <Topbar location={
          <>
            <a href="/child" className='topLink'>Child Nutrition</a>  &gt; Patient Select
          </>
        } />
      <div className="mainbarContent">
        ...
        <div className="main">
          <div className="main-container">
            ...
            <ChildModal  visible={isOpenAddModal} onClose={() => setIsOpenAddModal(false)} data={selectedPatient}/>
...
export default Patientselect_Child;
