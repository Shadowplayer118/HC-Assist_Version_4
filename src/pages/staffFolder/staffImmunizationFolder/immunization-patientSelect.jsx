...
import AddImmuni from './immunization-addModal';

const Patientselect_Immunization = () => {
  ...
  return (
    <div>
      <Topbar location={
          <>
            <a href="/immunization" className='topLink'>Immunization</a>  &gt; Patient Select
          </>
        } />
      <div className="mainbarContent">
        ...
        <div className="main">
          <div className="main-container">
            ...
            <AddImmuni  visible={isOpenAddModal} onClose={() => setIsOpenAddModal(false)} data={selectedPatient}/>
...
export default Patientselect_Immunization;
