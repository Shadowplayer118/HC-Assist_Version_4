...
const AddReferral = ({ visible, onClose, data }) => {
        ...
        <form onSubmit={handleSubmit}>
          <div className="addReferral-input-left">
            ...
            <div className="addReferral-preview-container">
              {preview && <img className="addReferral-preview" src={preview} alt="Preview" />}
            </div>
  ...
  ></textarea>
            ...
            <div className="addReferral-input-squeeze">
               ...
               <div className="input-container">
                ...
                <input type="date" id="addReferral-bdate" name="disease_treatmentSched"  onChange={(e) => setReferralDate(e.target.value)} required />
              </div>

              <div className="input-container">
                <label htmlFor="addReferral-blood_type">Approval Status:</label> <br />
                <select id="addReferral-blood_type" name="disease_status" onChange={(e) => setApprovalStatus(e.target.value)} required>
