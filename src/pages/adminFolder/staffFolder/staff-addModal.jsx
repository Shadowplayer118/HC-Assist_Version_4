...
const StaffAddModal = ({ visible, onClose, data }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost/HC-Assist_Version_4/php/new_php/HC-Assist_API/Admin/staff/add-Staff.php', formData, {
        headers: {
